...
export const NODES_IB = [
...

  {
    ...
    patches: [
      { id: "SROS-23.10-R2-P1", type: "Hotfix", desc: "BGP graceful-restart fix", installedDate: "2026-02-10", installedBy: "netops" },
      { id: "SROS-23.10-R2-P3", type: "Security", desc: "CVE-2025-41723 OpenSSL heap overflow", installedDate: "2026-03-15", installedBy: "secops" },
    ],
...
! ... [config not retrievable — node unreachable] ...`,
...

  {
    ...
    patches: [
      { id: "CSCwh12345", type: "SMU", desc: "BGP EVPN route-target memory leak fix", installedDate: "2026-03-01", installedBy: "dcops" },
      { id: "CSCwh67890", type: "SMU", desc: "VXLAN VNI scale improvement", installedDate: "2026-02-15", installedBy: "dcops" },
    ],
...
hostname ib-santantoni-acc-sw01`,
...

  {
    ...
    patches: [
      { id: "PAN-259498", type: "Content Update", desc: "App & Threat v8842-8345", installedDate: "2026-03-28", installedBy: "secops" },
      { id: "PAN-259112", type: "Hotfix", desc: "GlobalProtect portal auth bypass fix", installedDate: "2026-03-20", installedBy: "secops" },
      { id: "PAN-258901", type: "WildFire", desc: "WildFire content update 892451", installedDate: "2026-03-25", installedBy: "auto" },
    ],
